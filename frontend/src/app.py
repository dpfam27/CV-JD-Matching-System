    ...
    try:
        ...
        for skill, idx in vectorizer.vocabulary_.items():
            ...
            if jd_count > 0:  # Only include skills mentioned in JD
                skills_match[skill] = [int(resume_count), int(jd_count)]  # Convert to int for JSON
                if resume_count == 0:
        ...
        print("Scan result:", scan_result)  # Debug print
        ...
        print(f"Error in process_scan: {str(e)}")  # Debug print
